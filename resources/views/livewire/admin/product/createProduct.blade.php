<div class="panel panel-default" style="margin-top: 5px" >
    ...
    <div class="h3">Create Product</div>
...
<div class="panel-body">
    ...
    <div class="input-group">
        <br>
        {{-- store method for Product Livewire--}}
        <button wire:click="storeProduct()" class="btn btn-default">Save</button>
        {{-- Product storing Livewire--}}
        <div wire:loading wire:target="storeProduct">Creating...</div>
    </div>
</div>
</div>